...
<sup>**Exchange Online performance times based on an average mailbox of 26K items and a size of 10 GB.  For a single mailbox, restore times typically fall in the 200 – 300 item/minute range.</sup>
